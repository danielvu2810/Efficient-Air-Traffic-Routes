...
template<class ItemType>
bool BinarySearchTreeName<ItemType>::insert(const ItemType & newEntry)
{
...
template<class ItemType>
bool BinarySearchTreeName<ItemType>::remove(const ItemType & target)
{
...
template<class ItemType>
bool BinarySearchTreeName<ItemType>::getEntry(const ItemType& anEntry, ItemType & returnedItem) const
{
	bool isSuccessful = false;
...
template<class ItemType>
BinaryNode<ItemType>* BinarySearchTreeName<ItemType>::_insert(BinaryNode<ItemType>* nodePtr,
...
template<class ItemType>
BinaryNode<ItemType>* BinarySearchTreeName<ItemType>::_remove(BinaryNode<ItemType>* nodePtr,
...
template<class ItemType>
BinaryNode<ItemType>* BinarySearchTreeName<ItemType>::deleteNode(BinaryNode<ItemType>* nodePtr)
{
	if (nodePtr->isLeaf())
	{
		delete nodePtr;
...
template<class ItemType>
BinaryNode<ItemType>* BinarySearchTreeName<ItemType>::removeLeftmostNode(BinaryNode<ItemType>* nodePtr,
	ItemType & successor)
{
...
template<class ItemType>
BinaryNode<ItemType>* BinarySearchTreeName<ItemType>::findNode(BinaryNode<ItemType>* nodePtr,
